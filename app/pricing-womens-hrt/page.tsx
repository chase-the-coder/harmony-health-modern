...
export const metadata = getSEOTags({
  title: "Women's Hormone Replacement Pricing | Harmony Health Athens GA",
  description:
    "Transparent cash-pay pricing for Women's Hormone Replacement Therapy at Harmony Health. Establish Care, Hormone Membership, Hormone Pellets, and a la carte lab work. HSA/FSA accepted.",
  canonicalUrlRelative: "/pricing-womens-hrt",
});
...
export default function WomensHrtPricingPage() {
  return (
    <>
      <Header />
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="hh-h2 mb-5">Women&rsquo;s Hormone Replacement Pricing</h2>
          ...
          <div className="max-w-[640px] mx-auto">
            <div className="border border-[#6B9680] rounded-[5px] bg-white overflow-hidden">
              ...
              <div className="px-6 pb-6 pt-2 text-center">
                <BookingButton href={BOOKING_URLS.womensHrt}>Book Appointment</BookingButton>
              </div>
            </div>
          </div>
        </div>
